...
import com.fintech.Bank.exceptions.InsufficientBalanceException;
...
public class TransactionServiceImpl implements TransactionService{
    ...
    public Response<List<TransactionDTO>> getTransactionsForMyAccount(String accountNumber, int page, int size) {
      ...
      if(!account.getUser().getId().equals(user.getId())){
          throw new BadRequestException("Account does to belong to authenticated user");
      }
      ...
      return Response.<List<TransactionDTO>>builder()
              ...
              .meta(Map.of("currentPage",txns.getNumber(),"totalItems",txns.getTotalElements(),"totalPages",txns.getTotalPages(),"pageSize",txns.getSize() ))
              .build();
    }
    ...
    private void handleTransfer(TransactionRequest transactionRequest,Transaction transaction) {
        ...
        Account destination= accountRepo.findByAccountNumber(transactionRequest.getDestinationAccountNumber())
